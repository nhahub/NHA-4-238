        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainingAppointments_Plans_PlanId",
                        column: x => x.PlanId,
                        principalTable: "Plans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionAttendaces", x => new { x.MemberId, x.SessionId });
                    table.ForeignKey(
                        name: "FK_SessionAttendaces_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "MemberId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SessionAttendaces_Sessions_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Packages_PlanId",
                table: "Packages",
                column: "PlanId");

            migrationBuilder.CreateIndex(
                name: "IX_Plans_SportId",
                table: "Plans",
                column: "SportId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionAttendaces_SessionId",
                table: "SessionAttendaces",
                column: "SessionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingAppointments_PlanId",
